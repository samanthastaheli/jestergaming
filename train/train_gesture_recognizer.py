...
# region Verify the labels 
# There should be x gesture labels, with one of them being the `none` gesture.
...
hparams = gesture_recognizer.HParams(learning_rate=0.003, export_dir="exported_model2")
...
hparams = gesture_recognizer.HParams(learning_rate=0.003, export_dir="exported_model")
model_options = gesture_recognizer.ModelOptions(dropout_rate=0.2)
options = gesture_recognizer.GestureRecognizerOptions(model_options=model_options, hparams=hparams)
...
# region Evaluate the model performance
